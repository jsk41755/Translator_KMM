...
android {
    namespace = "com.devjeong.translator_kmm.android"
    compileSdk = 33
    defaultConfig {
        applicationId = "com.devjeong.translator_kmm.android"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"

        testInstrumentationRunner = "com.devjeong.translator_kmm.TestHiltRunner"
    }
    buildFeatures {
        compose = true
    }
